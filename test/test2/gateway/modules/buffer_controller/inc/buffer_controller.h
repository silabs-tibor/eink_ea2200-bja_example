...
void buffer_controller_initSendingStuff(void);
uint8_t * buffer_controller_getBytestreamDTMxValues(uint8_t , uint16_t );
uint8_t buffer_controller_getamountOfFrames(void);
uint8_t buffer_controller_getamountOfEntireChunks(void);
uint8_t buffer_controller_getRemainedBytesInLastTurn(void);
